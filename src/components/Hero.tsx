        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="space-y-6 md:space-y-10 md:w-1/2">
            <div className="space-y-0 md:space-y-1">
              ...
              <AnimatedElement delay={0.8} direction="left">
            ...
            <AnimatedElement delay={1.1} direction="left">
          ...
          <AnimatedElement delay={0.8} direction="right" className="md:w-1/2">
            <div className="relative">
              ...
              <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-accent/10">
                <div className="space-y-6">
                  <motion.div 
                    className="flex items-center gap-6 p-4 bg-white/80 rounded-2xl border border-accent/10 hover:shadow-md transition-all"
